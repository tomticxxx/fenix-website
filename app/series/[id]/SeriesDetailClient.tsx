...
import { 
  ChevronLeft, Check, Table, Activity, Cpu, Settings, MessageSquareQuote, ShieldCheck 
} from "lucide-react";
...
export default function SeriesDetailClient({ id }: { id: string }) {
